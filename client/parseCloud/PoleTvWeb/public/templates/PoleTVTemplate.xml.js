var Template = function() { return `<?xml version="1.0" encoding="UTF-8" ?>
  <document>
    <catalogTemplate> 
      <banner> 
        <title>Betty Yein Pole Television</title>
      </banner>
      <list> 
        <section> 
	  <listItemLockup> 
	    <title>Calentamiento</title>
	    <subtitle>Subtitulo de calentamiento</subtitle>
	    <decorationLabel>13</decorationLabel>
            //1. add from here
	    <relatedContent> 
	      <grid>
	        <section> 
	        <header> Sección 1</header>
                  //2
		  <lockup videoURL="${this.BASEURL}videos/BothSides.mp4">
		  <title>Título puesto con tag
		  <subtitle>subtítulo</subtitle></title>
	  ...
	  <listItemLockup> 
	    ...
	    <relatedContent> 
	      <grid>
	        <section> 
             <header> Sección 2</header>     //2
		  <lockup videoURL="${this.BASEURL}videos/bettyyein_test.mp4">
		    <img src="${this.BASEURL}images/ray.png" width="500" height="308" />
		  </lockup>		
		</section>
	      </grid>
